...
<body>
    <div class="container">
        <form id="form" class="registration-form" method="POST" action="<?php echo e(route('register')); ?>">
            <?php echo csrf_field(); ?>
            <h2>Register</h2>
...
<?php /**PATH D:\Aditya workspace\Laravel\firstProject\resources\views/auth/registration.blade.php ENDPATH**/ ?>